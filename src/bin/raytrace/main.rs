...
fn main() {
    ...
    let mut bvh = upload_bvh(vec![]).make_unique();
    ...
    let mut viewport_constants_buf = upload_buffer(0.0f32).make_unique();
    ...
    let mut sharpen_amount = const_f32(0.0f32).make_unique();
