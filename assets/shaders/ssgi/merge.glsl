...
void main() {
    ...
    vec3 sun_color = sample_quantized_environment_light(light_dir_pad.xyz) * vec3(1.3, 1, 0.7) * 2.0;
    //vec3 sun_color = sample_quantized_environment_light(light_dir_pad.xyz) * 2.0;
